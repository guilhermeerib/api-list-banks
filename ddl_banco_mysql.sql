-- ddl_banco_mysql.sql
create schema if not exists revgas_estagio;
use revgas_estagio;

CREATE TABLE IF NOT EXISTS revgas_estagio.banco (
    id INT PRIMARY KEY,
    nome VARCHAR(100)
);
-- dml inserção dos dados da tabela.
insert into revgas_estagio.banco ( id,nome) 
values 
